		...
		<tr>
					...
					<br>
					<p><button class="btn btn-default" type="submit">Updatera kundvagnen</button> 
		...
		<div class="panel panel-default panel-list">
			...
			<div class="panel panel-default panel-list">
				...
				<?php  foreach(get_popular_h() as $popular) :?>
					<li class="list-group-item"><a href="<?php echo base_url(); ?>products/details/<?php echo $popular->id; ?>"><?php echo $popular->product_title; ?></a></li>
				<?php endforeach; ?>
